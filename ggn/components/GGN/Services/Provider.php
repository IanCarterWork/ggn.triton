<?php
	...
	class Provider{
		...
		public function AllowAccess(){
			...
			header('Access-Control-Allow-Methods: POST, GET, OPTIONS, PATCH, DISPATCH, DELETE, HEAD, CONNECT, TRACE');
		...
		public function AuthCurrentVendor(){
      	...
      	public function Build() : ?string {
			...
			if(!$UseCustomizeInputData){
				...
				$Class->Input = $this->ARC->GetBody() ?: ((Object) $_REQUEST);
